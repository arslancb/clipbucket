<?php
	...
	function uninstall_ldap_client()	{
		global $db;
		$db->Execute(
	...
	function remove_ldap_client_langage_pack($lang){
		global $db,$lang_obj;
	...
	uninstall_ldap_client();
	remove_ldap_client_langage_pack('fr');
	remove_ldap_client_langage_pack('en');
?>
